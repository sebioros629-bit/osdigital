...
const demos = [
  { id: "01", title: "PRODUCT SHOWCASE",           industry: "UGC STYLE",      video: "https://vjs.zencdn.net/v/oceans.mp4", duration: "00:15" },
  { id: "02", title: "SHOWROOM REVIEW",            industry: "SHOWCASE",       video: "https://vjs.zencdn.net/v/oceans.mp4", duration: "00:20" },
  { id: "03", title: "FASHION BRAND REVIEW",       industry: "PRODUCT REVIEW", video: "https://vjs.zencdn.net/v/oceans.mp4", duration: "00:18" },
  { id: "04", title: "GYM PRODUCT REVIEW",         industry: "PRODUCT REVIEW", video: "https://vjs.zencdn.net/v/oceans.mp4", duration: "00:16" },
  { id: "05", title: "SKINCARE UNBOXING AND REVIEW", industry: "UNBOXING",     video: "https://vjs.zencdn.net/v/oceans.mp4", duration: "00:17" },
];
          ...
          <div className="absolute top-6 left-6 right-6 md:top-8 md:left-8 md:right-8 flex justify-between items-center z-30">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="w-10 h-10 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center text-white hover:bg-white hover:text-sky-500 transition-all shadow-xl opacity-100 lg:opacity-0 lg:group-hover:opacity-100"
              >
